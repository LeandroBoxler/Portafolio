...
import { FaFolderOpen, FaFolder, FaTimes, FaChevronDown, FaChevronUp } from "react-icons/fa";
...
export const Proyect = ({ proyects, toggleOpenWindowProyect, open, onClick, zIndex, onClosed }: Props) => {
  ...
  return (
    <motion.div
      ...
      onClick={onClick}
    >
      <div className={`p-4 border-b border-[#808080] bg-[#000080] text-white flex items-center justify-between
        ...
        {proyects.map((e, i) => (
          <div 
            ...
            className={`border-b border-b-[#808080] last:border-b-0 ${
              !isMobile && open.includes(e.id) ? "bg-[#E0E0E0] text-[#000080]" : ""
            }`}
          >
            <button
            ...
            >
              <div className="flex-shrink-0">
                {isMobile ? 
                  (expandedId === e.id ? <FaFolderOpen /> : <FaFolder />) : 
                  <FaFolder />
                }
              </div>
              ...
              {isMobile && (
                ...
                >
                  {expandedId === e.id ? <FaChevronUp size={12} /> : <FaChevronDown size={12} />}
                </motion.div>
              )}
            </button>
