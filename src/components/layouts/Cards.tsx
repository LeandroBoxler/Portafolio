 ...
 useEffect(() => {
  ...
  if (mobile) {
    return (
      ...
      dragListener={minimize?false:true}
      ...
      >
        ...
        >
          <p className="select-none flex-1 font-medium text-gray-800">{title}</p>
                <button
        ...
        <div className={`bg-white p-4  flex flex-col mt-64"} p-10`}>{children}</div>
        <div className="p-10">
        <button
            onClick={onClosed}
