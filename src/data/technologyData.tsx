...
import { SiTypescript, SiHtml5, SiCss3, SiExpress, SiMysql, SiTailwindcss, SiJira, SiDotnet, SiSharp } from "react-icons/si";
...
export const technologies: TechnologyData[] = [
  ...
  { name: "C#", icon: <SiSharp />, bgColor: "bg-purple-50", textColor: "text-purple-700", category: "Lenguajes" },
  ...
  { name: ".NET", icon: <SiDotnet />, bgColor: "bg-indigo-50", textColor: "text-indigo-600", category: "Frameworks" },
