...
export const Card = ({ limitDragAndDrop, onClick, children, title, className,classNameTitle,onClosed }: Props) => {
...
>
      ...
      >
<p className="select-none flex-1 truncate">{title}</p>
<button className="border-2 min-w-[24px] max-w-[32px] aspect-square text-center border-t-white bg-red-500 border-l-white border-r-gray-500 border-b-gray-500 text-black font-bold flex items-center justify-center"
onClick={onClosed} >
  <FaTimes />
</button>
